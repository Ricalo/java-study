...
public class BubbleSort extends AbstractArraySort {
   ...
   * @param start The index that defines the first element of the subarray to be sorted.
   * @param end   The index that defines the last element of the subarray to be sorted.
